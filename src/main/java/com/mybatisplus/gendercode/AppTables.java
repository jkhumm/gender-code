...
public class AppTables extends TableInfos {
    private static final String ROOT_DIR = "../small_world/world-mybatiesplus/src/main/java";
    private static final String PACKAGE_PARENT_NAME = "com.huke.app";
    ...
    private static final String RESOURCES_DIR = "../small_world/world-mybatiesplus/src/main/java/com/huke/app";
